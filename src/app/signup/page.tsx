...
function SignupContent() {
  ...
  useEffect(() => {
    ...
    if (err === "OAuthAccountNotLinked") {
      setError("An account with this email already exists. Please log in using your original method (e.g., Email and Password).");
      ...
      <Card className="border-2 border-foreground">
        ...
        <CardContent>
          ...
          <Button
            ...
            onClick={() => signIn("google", { callbackUrl: "/dashboard/member" })}
          >
